...
EXPERIENCES = [
    {
        'title': 'Cape Coast Castle', 'slug': 'cape-coast-castle', 'category': 'history', 'tier': 'signature', 'region': 'Central',
        ...
        'is_bookable': False, 'booking_url': '',
    },
    {
        'title': 'Kakum National Park', 'slug': 'kakum-national-park', 'category': 'nature', 'tier': 'signature', 'region': 'Central',
        'address': 'Kakum National Park Road, Central Region',
    ...
    {
        'title': 'W.E.B. Du Bois Memorial Centre', 'slug': 'web-du-bois-memorial-centre', 'category': 'culture', 'tier': 'featured', 'region': 'Greater Accra',
        'address': 'Fifth Circular Road, Cantonments, Accra',
